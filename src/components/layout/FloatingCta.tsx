...
export function FloatingCta({
  ...
  return (
    <div
      className={cn(
        "fixed bottom-7 z-40 hidden transition-all duration-300 lg:block ltr:right-7 rtl:left-7",
        visible && !hidden
    ...
    >
      ...
      >
        <span className="relative flex h-2 w-2">
          <span className="absolute inline-flex h-full w-full motion-safe:animate-ping rounded-full bg-ink/40" />
